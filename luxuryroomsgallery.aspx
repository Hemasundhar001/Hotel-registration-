<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="luxuryroomsgallery.aspx.cs" Inherits="hotel_registrion_project.luxuryroomsgallery" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div style="font-size: large; text-align: center;">
                <asp:Label ID="Label1" runat="server" Font-Size="Large" Text="Luxury Room Gallery"></asp:Label>
                &nbsp;&nbsp;&nbsp;<br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Image ID="Image3" runat="server" Height="386px" ImageUrl="~/room/1.jpg" Width="413px" />
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Image ID="Image4" runat="server" Height="386px" ImageUrl="~/lroom/2.jpg" Width="413px" />
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Image ID="Image5" runat="server" Height="386px" ImageUrl="~/lroom/3.jpg" Width="413px" />
                <br />
                <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Image ID="Image6" runat="server" Height="386px" ImageUrl="~/lroom/4.jpg" Width="413px" />
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Image ID="Image7" runat="server" Height="386px" ImageUrl="~/lroom/5.jpg" Width="413px" />
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Image ID="Image8" runat="server" Height="386px" ImageUrl="~/lroom/6.jpg" Width="413px" />
                <br />
&nbsp;&nbsp;&nbsp;
                <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Image ID="Image9" runat="server" Height="386px" ImageUrl="~/lroom/7.jpg" Width="413px" />
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Image ID="Image10" runat="server" Height="386px" ImageUrl="~/lroom/8.jpg" Width="413px" />
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Image ID="Image11" runat="server" Height="386px" ImageUrl="~/lroom/9.jpg" Width="413px" />
                <br />
                <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Image ID="Image12" runat="server" Height="386px" ImageUrl="~/lroom/10.jpg" Width="413px" />
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Image ID="Image13" runat="server" Height="386px" ImageUrl="~/lroom/11.jpg" Width="413px" />
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Image ID="Image14" runat="server" Height="386px" ImageUrl="~/lroom/12.jpg" Width="413px" />
                <br />
                <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Image ID="Image15" runat="server" Height="386px" ImageUrl="~/lroom/13.jpg" Width="413px" />
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Image ID="Image16" runat="server" Height="386px" ImageUrl="~/lroom/14.jpg" Width="413px" />
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Image ID="Image17" runat="server" Height="386px" ImageUrl="~/lroom/15.jpg" Width="413px" />
                <br />
                <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Image ID="Image18" runat="server" Height="386px" ImageUrl="~/lroom/16.jpg" Width="413px" />
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Image ID="Image19" runat="server" Height="386px" ImageUrl="~/lroom/17.jpg" Width="413px" />
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Image ID="Image20" runat="server" Height="386px" ImageUrl="~/lroom/18.jpg" Width="413px" />
                <br />
                <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Image ID="Image21" runat="server" Height="386px" ImageUrl="~/lroom/19.jpg" Width="413px" />
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Image ID="Image22" runat="server" Height="386px" ImageUrl="~/lroom/20.jpg" Width="413px" />
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Image ID="Image23" runat="server" Height="386px" ImageUrl="~/lroom/9.jpg" Width="413px" />
                <br />
                <br />
